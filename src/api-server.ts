...
// 消息处理器引用
let messageHandler: ((msg: SimulatedMessage) => Promise<void>) | null = null;
 ...
 */
export function setClient(client: any, handler: (msg: SimulatedMessage) => Promise<void>): void {
 ...
 * 创建 API 服务器
 */
export function createApiServer(port: number = 4098): http.Server {
